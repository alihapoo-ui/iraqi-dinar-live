...
def get_latest_pmc_rate() -> float:
    ...
    if not API_ID or not API_HASH or not STRING_SESSION:
        raise RuntimeError("Missing Telegram credentials (API_ID, API_HASH, or STRING_SESSION)")
    ...
    try:
        ...
        raise RuntimeError(f"Failed to fetch PMC rate: {e}")
...
def get_fx_rates() -> dict:
    ...
    try:
        ...
        raise RuntimeError(f"Failed to fetch FX rates: {e}")
